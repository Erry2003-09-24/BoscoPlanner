...
class _HistoryPageState extends State<HistoryPage> {
  ...
  Future<void> _clearHistory() async {
    bool? confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Sei sicuro di voler cancellare tutto lo storico?'),
        actions: [
          TextButton(
  ...
  Widget _buildList(String title, List<Map<String, dynamic>> list, IconData icon, Color color) {
    return Expanded(
      child: Column(
